...
<dd>**File menu**: Create new project, download or share projects, etc.</dd>
<dt><i className="bp-pencil-ruler"></i></dt>
<dd>**Edit menu**: Undo/redo (up to 30 steps), subdivide grid, rotate/flip, select/unselect all.</dd>
<dt><i className="bp-tasks"></i></dt>
<dd>**Setting menu**: Display options and app preferences (language, theme, color scheme, etc.).</dd>
<dt><i className="bp-tools"></i></dt>
<dd>**Tools menu**: Optimize layout, import from [TreeMaker](https://langorigami.com/article/treemaker/) format, and CP exporting.</dd>
<dt><i className="bp-question-circle"></i></dt>
<dd>**Help menu**: About the app, version info, and how to support it.</dd>
<dt><i className="bp-tree"></i></dt>
<dd>**Tree structure**: Edit the tree structure of your project.</dd>
<dt><i className="bp-layout"></i></dt>
<dd>**Layout**: Edit the Flap and Gadget layout of your project.</dd>
<dt><i className="bp-sliders-h"></i></dt>
<dd>**Option panel** (only in mobile version): Opens the option panel. For desktop version the option panel is always in display on the right side.</dd>
</dl>
...
For a very brief account of the method of generating stretch patterns used in this app, see [[2]](/en/notes#bibliography) and [[3]](/en/notes#bibliography).
